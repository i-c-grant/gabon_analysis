...
wd_raster <- rast("/home/ian/projects/gabon/data/wood_density/wd-to-share/yang/wd_avg_1km_xgboost.tif") %>%
  project("EPSG:4326")

# Load GEDI shots and convert to SpatVector
gedi_shots <- st_read("/home/ian/projects/gabon/data/model_output/gabon_1-29_with_cleanup.gpkg")
gedi_vect <- vect(gedi_shots)

# Load Gabon boundary and calculate mean wood density
gabon_boundary <- st_read("/home/ian/projects/gabon/data/boundaries/gabon_boundary.gpkg")
...
# Save results
st_write(gedi_shots, "gabon_agbd_results.gpkg", append = FALSE)
